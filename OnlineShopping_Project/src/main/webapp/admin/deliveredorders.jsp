...
<table id="customers">
          ...
          try
          {
      		...
      		ResultSet  rs=smt.executeQuery("select*from cart inner join product where cart.product_id=product.id and cart.orderdate is not NULL and cart.status='delivered'");
      		while(rs.next())
      		{
